...
После отправки пользователем отзыва, выбранная оценка и текст отзыва отображаются в личном кабинете getform.io (да, я могу читать всё, что вы мне там отправляете по приколу).
